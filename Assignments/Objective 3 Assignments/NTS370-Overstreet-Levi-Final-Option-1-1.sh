...
# The following script will pull the following fields from /etc/passwd and print them sorted alphabetically, Username, Home Directory, and Shell.
...
# This is the command to pull the Username, Home Directory, and Shell from /etc/passwd and print it.
awk -F':' '{print $1,$6,$7}' /etc/passwd | sort 
